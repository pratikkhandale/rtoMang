<%@page import="com.rto.controller.VehicleRegistrationCtl"%>
 ...
 <div class="container mtb">
    <div class="row">
      ...
      <marquee behavior="scroll" direction="right" scrollamount="10"><img alt="" src="../images/boy.jpg"></div></marquee>
        <h2>Welcome to RTO, Register Your Vehicle here</h2>
        ...
        <br>
        <div class="hline"></div>
        <form action="<%=RTOView.Vehile_Regustration_Ctl%>" method="post">
  ...
  <div class="form-group">
   ...
   <div class="form-check form-check-inline">
        <label for="formGroupExampleInput">Vehicle Type</label> &nbsp
  <input class="form-check-input"  type="radio" name="typeofvehicle" id="inlineRadio1" value="Two Wheeler">
  <label class="form-check-label" for="inlineRadio1">Two wheeler</label>
	
<!-- <div class="form-check form-check-inline"> -->
  <input class="form-check-input" type="radio" name="typeofvehicle" id="inlineRadio2" value="Four Wheeler">
  <label class="form-check-label" for="inlineRadio2">&nbsp&nbspFour Wheeler</label><br>
  ...
  <button type="submit" class="btn btn-primary mb-2" value="<%=VehicleRegistrationCtl.OP_SIGN_UP%>" name="operation">Register vehicle</button>
