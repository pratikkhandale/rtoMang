 ...
 <div class="container mtb">
    <div class="row">
      <div class="col-lg-8 col-lg-offset-2 centered">
        <h2>Welcome to RTO, Update Users</h2>
        ...
        <br>
        <div class="hline"></div>
        <form action="<%=RTOView.USER_CTL%>" method="post">
  ...
  <button type="submit" class="btn btn-primary mb-2" value="<%=UserCtl.OP_SAVE%>" name="operation">Update</button>
